...
NPplotjune <- ggplot(nutrients_june, aes(x = log(shad_cpe_electrofishing + 0.05), y = sqrt(NPratio), colour = Impoundment)) +
  geom_point()+
  theme_cowplot(12)+
  labs(y="Sqrt(N:P Ratio)", x=expression(paste("Ln(Gizzard Shad Min"^-1," + 0.05)"))) +
  theme(legend.position = "none")+
  geom_smooth(method="lm",se=FALSE) 
NPplotjune
...
NPplotaug <- ggplot(nutrients_aug, aes(x = log(shad_cpe_electrofishing + 0.05), y = sqrt(NPratio), colour = Impoundment)) +
  geom_point()+
  theme_cowplot(12)+
...
NPplotoct <- ggplot(nutrients_oct, aes(x = log(shad_cpe_electrofishing + 0.05), y = sqrt(NPratio), colour = Impoundment)) +
  geom_point()+
  theme_cowplot(12)+
  labs(y="", x=expression(paste("Ln(Gizzard Shad Min"^-1," + 0.05)"))) +
...
ggsave(filename = "9panelplot.png", dpi = 600)
